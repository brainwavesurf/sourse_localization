...
#    #all
#    inverse_operator_isi = make_inverse_operator(epo_isi.info, fwd, noise_cov, loose=0.2, depth=0.8, verbose=True)
#    inverse_operator_post = make_inverse_operator(epo_post.info, fwd, noise_cov, loose=0.2, depth=0.8, verbose=True)
##    
...
#    stc_post_slow.data = psd_avg
    ...
    stc = stc_isi_fast
    stc.data = abs(stc_isi_fast.data - stc_isi_slow.data)/stc_isi_slow.data  
