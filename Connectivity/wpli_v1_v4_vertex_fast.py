...
for subject in SUBJECTS:
    ...
    stcs_fast_v4 = apply_inverse_epochs(allepochs, inverse_operator, lambda2, method='sLORETA',
    ...
    idx_v4 = np.searchsorted(stcs_fast[0].vertices[1], stcs_fast_v4[0].vertices[1])
...
# Save   
np.save(savepath + 'wpli2_debiased/' + 'all_v1_v4_vertices_fast_allepo', all_v1_mt)
all_subj = np.load(savepath + 'wpli2_debiased/' + 'all_v1_v4_vertices_fast_allepo.npy')
...
plt.savefig(savepath + 'wpli2_debiased/' + 'all_v1_v4_vertices_fast_allepo')
