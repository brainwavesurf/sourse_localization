...
for subject in SUBJECTS:
    ...
    v1_label_part = v1_label.split(parts=30, subject=subject, subjects_dir=subjects_dir, freesurfer=True)
    mt_label_part = mt_label.split(parts=5, subject=subject, subjects_dir=subjects_dir, freesurfer=True)
