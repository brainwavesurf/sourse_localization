...
for subject in SUBJECTS:
    ...
    for epo in epochs:
        ...
        if subject in SUBJ_ASD:
            if epo.events[0][2] == 2:
                all_subj_v1_v4_asd_slow.append(granger_all_v1_v4)
                all_subj_v4_v1_asd_slow.append(granger_all_v4_v1)
            elif epo.events[0][2] == 4:
                all_subj_v1_v4_asd_medium.append(granger_all_v1_v4)
                all_subj_v4_v1_asd_medium.append(granger_all_v4_v1)
            else:
                all_subj_v1_v4_asd_fast.append(granger_all_v1_v4)
                all_subj_v4_v1_asd_fast.append(granger_all_v4_v1)
        else:
            if epo.events[0][2] == 2:
                all_subj_v1_v4_nt_slow.append(granger_all_v1_v4)
                all_subj_v4_v1_nt_slow.append(granger_all_v4_v1)
            elif epo.events[0][2] == 4:
                all_subj_v1_v4_nt_medium.append(granger_all_v1_v4)
                all_subj_v4_v1_nt_medium.append(granger_all_v4_v1)
            else:
                all_subj_v1_v4_nt_fast.append(granger_all_v1_v4)
                all_subj_v4_v1_nt_fast.append(granger_all_v4_v1)
                
        
np.save(savepath + 'granger/' + 'all_v1_v4_nt_vert_slow', all_subj_v1_v4_asd_slow)
...
np.save(savepath + 'granger/' + 'all_v1_v4_nt_vert_medium', all_subj_v1_v4_asd_medium)
...
np.save(savepath + 'granger/' + 'all_v1_v4_nt_vert_fast', all_subj_v1_v4_asd_fast)
