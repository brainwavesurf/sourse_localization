...
for subject in SUBJECTS:
    ...
    stc_fsaverage_diff = stc_fsaverage_fast.data[:,6:13] - stc_fsaverage_slow.data[:,6:13]
...
X_abs = stc_str
X_abs.data = X_avg
X_abs.save(savepath + '1_results/average_meg_diff/' + '10_17_avg_abs_diff')
...
X_abs_ASD.save(savepath + '1_results/average_meg_diff/' + 'ASD_10_17_avg_abs_diff')
...
X_abs_NT = stc_str
X_abs_NT.data = X_avg
X_abs_NT.save(savepath + '1_results/average_meg_diff/' + 'NT_10_17_avg_abs_diff')

X_diff = stc_fsaverage_slow
X_diff.data = X_abs_NT.data - X_abs_ASD.data
X_diff.save(savepath + '1_results/average_meg_diff/' + 'NTvsASD_10_17_avg_abs_diff')