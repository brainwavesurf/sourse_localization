...
for subject in SUBJECTS:
    ...
    #load stcs
    sum_csp = mne.read_source_estimate(savepath + '1_results/CSP_sum/' + subject + 'sum_CSP_1_3_V3-V1')
    #sum_csp = mne.read_source_estimate(savepath + '1_results/CSP_sum/' + subject + 'sum_CSP_4_6_V3-V1')
...
avg_CSP_sum.save(savepath + '1_results/average_CSP_sum/' + 'avg_sum_CSP_1_3')
#avg_CSP_sum.save(savepath + '1_results/average_CSP_sum/' + 'avg_sum_CSP_4_6')
...
avg_CSP_sum = sum_csp_fsaverage
avg_CSP_sum.data = X_avg_sum
avg_CSP_sum.save(savepath + '1_results/average_CSP_sum/' + 'NT_avg_sum_CSP_1_3')
#avg_CSP_sum.save(savepath + '1_results/average_CSP_sum/' + 'avg_sum_CSP_4_6')
...
avg_CSP_sum = sum_csp_fsaverage
avg_CSP_sum.data = X_avg_sum
avg_CSP_sum.save(savepath + '1_results/average_CSP_sum/' + 'ASD_avg_sum_CSP_1_3')
#avg_CSP_sum.save(savepath + '1_results/average_CSP_sum/' + 'avg_sum_CSP_4_6')