...
avg_CSP_sum_NT.save(savepath + '1_results/average_CSP_sum/' + 'NT_avg_sum_CSP_97_99_new')
...
avg_CSP_sum_ASD.save(savepath + '1_results/average_CSP_sum/' + 'ASD_avg_sum_CSP_97_99_new')

avg_CSP_sum_group_diff = sum_csp_fsaverage
avg_CSP_sum_group_diff.data = avg_CSP_sum_NT.data - avg_CSP_sum_ASD.data
avg_CSP_sum_group_diff.save(savepath + '1_results/average_CSP_sum/' + 'NTvsASD_avg_sum_CSP_97_99_new')