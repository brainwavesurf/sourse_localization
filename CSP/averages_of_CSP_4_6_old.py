...
for subject in SUBJ_NT:
    ...
    #sum and save
    diff_sum_4_6 = stc_diff
    diff_sum_4_6.data = sum(diff)
    ...
    sum_csp_fsaverage = morph.apply(diff_sum_4_6)
...
avg_CSP_sum_NT.save(savepath + '1_results/average_CSP_sum/' + 'NT_avg_sum_CSP_4_6_old')
...
avg_CSP_sum_ASD.save(savepath + '1_results/average_CSP_sum/' + 'ASD_avg_sum_CSP_4_6_old')

avg_CSP_sum_group_diff = sum_csp_fsaverage
avg_CSP_sum_group_diff.data = avg_CSP_sum_NT.data - avg_CSP_sum_ASD.data
avg_CSP_sum_group_diff.save(savepath + '1_results/average_CSP_sum/' + 'NTvsASD_avg_sum_CSP_4_6_old')