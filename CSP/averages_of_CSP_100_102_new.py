...
for subject in SUBJ_NT:
    ...
    CSP = ['100','101','102']
    for num in CSP:
        stc_diff = mne.read_source_estimate(savepath + subject + '/' + subject + 'csp_V3-V1' + num)      
        diff.append(stc_diff.data)        
    #sum and save
    diff_sum_100_102 = stc_diff
    diff_sum_100_102.data = sum(diff)
    ...
    sum_csp_fsaverage = morph.apply(diff_sum_100_102)
...
avg_CSP_sum_NT.save(savepath + '1_results/average_CSP_sum/' + 'NT_avg_sum_CSP_100_102_new')
...
avg_CSP_sum_ASD.save(savepath + '1_results/average_CSP_sum/' + 'ASD_avg_sum_CSP_100_102_new')

avg_CSP_sum_group_diff = sum_csp_fsaverage
avg_CSP_sum_group_diff.data = avg_CSP_sum_NT.data - avg_CSP_sum_ASD.data
avg_CSP_sum_group_diff.save(savepath + '1_results/average_CSP_sum/' + 'NTvsASD_avg_sum_CSP_100_102_new')